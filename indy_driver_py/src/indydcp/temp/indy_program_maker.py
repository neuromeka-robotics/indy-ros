...
from . import indydcp_client as client
import functools
...
class JsonProgramComponent:
    def __init__(self, policy=0, resume_time=2, var_name=None, var_value=None, var_type=None):
        # Init
        self.wp_id = 0
        self.program_id = 3
        self.cmd_id = 0
        ...
        if var_name is None:
            ...
            self.varList = [dict(name=self.varName, value=self.varValue, type=self.varType)]
