...
#include <ros/ros.h>
#include <sdf/sdf.hh>
#include "vacuum_gripper_simulation/ROSVacuumGripperPlugin.hh"
#include "vacuum_gripper_simulation/VacuumGripperControl.h"
#include "vacuum_gripper_simulation/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  {
    robotNamespace = _parent->GetName(); // default
  }
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    vacuum_gripper_simulation::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  vacuum_gripper_simulation::VacuumGripperControl::Request &_req,
  vacuum_gripper_simulation::VacuumGripperControl::Response &_res)
{
...
{
  vacuum_gripper_simulation::VacuumGripperState msg;
