...
// ROS
#include <conveyor_belt_simulation/ConveyorBeltControl.h>
#include <ros/ros.h>
...
namespace gazebo
{
  ...
  class ROSConveyorBeltPlugin : public ConveyorBeltPlugin
  {
    ...
    public: bool OnControlCommand(ros::ServiceEvent<
      conveyor_belt_simulation::ConveyorBeltControl::Request,
      conveyor_belt_simulation::ConveyorBeltControl::Response> & event);
