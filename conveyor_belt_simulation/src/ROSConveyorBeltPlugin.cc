...
#include "conveyor_belt_simulation/ConveyorBeltState.h"
...
void ROSConveyorBeltPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->statePub = this->rosnode_->advertise<
    conveyor_belt_simulation::ConveyorBeltState>(stateTopic, 1000);
}

/////////////////////////////////////////////////
void ROSConveyorBeltPlugin::Publish() const
{
  conveyor_belt_simulation::ConveyorBeltState stateMsg;
...
bool ROSConveyorBeltPlugin::OnControlCommand(ros::ServiceEvent<
  conveyor_belt_simulation::ConveyorBeltControl::Request, conveyor_belt_simulation::ConveyorBeltControl::Response> & event)
{
  const conveyor_belt_simulation::ConveyorBeltControl::Request& req = event.getRequest();
  conveyor_belt_simulation::ConveyorBeltControl::Response& res = event.getResponse();
